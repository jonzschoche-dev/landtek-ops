...
def annex():
    ...
    L.append("| Input | Low | Base | High | Status |")
    L.append("|---|---|---|---|---|")
    L.append(row("Throughput, tonnes/day", W2["tpd"], lambda v: f"{v:g}") + " 50 t/d = the Gracesen ECC precedent rating |")
    ...
    L.append(row("Simple payback on capex + permits, months", pay, lambda v: "n/a" if v == float("inf") else f"{v:,.0f}"))
    L.append("")
