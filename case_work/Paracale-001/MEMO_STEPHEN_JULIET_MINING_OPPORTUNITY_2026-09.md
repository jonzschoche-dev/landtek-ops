...
**Wave 2 — Jose Panganiban.** Allan's Minahang Bayan declared, and AVI Gold Processing on Allan's own land beside it, designed from the LAB X programme and sited and permitted with the whole model in view. Stephen's assessment is that ore supply there is not the constraint; the plant sets the pace.

**Wave 3 — the exploration upside.** When Waves 1 and 2 are running and audited, PGC proposes an earn-in on the NIBDC tenement through a project company, with Stephen's coexistence model between the large-scale permit and the small-scale cooperative as the working chapter. That project company is what a Canadian exchange lists.

---

## How it fits together

Philippine law fixes the shape, and the shape works. Filipinos hold the small-scale mining contracts and at least 60% of any mine once it converts to a production agreement; a foreign company may own the processing, the financing, the trading and the exploration-stage tenement. So the model has two layers that fit each other:
...
The order of entry is deliberate: **the Canadians come in at Wave 1, before NIBDC is approached.** PGC invests in Allan's company first; that company does the deal with Stephen; and the tenement negotiation, when it comes, is made by a funded company from an operating position rather than by individuals from a concept. **Control sits in those two vehicles** — Allan's company and PGC — and every role in the partnership, including Stephen's and ours, is earned in stages against written milestones, so nothing load-bearing rests on any one person. It is the shape the largest gold mine in the country runs on — a Filipino tenement company with a foreign minority partner that owns the processing outright — and the shape the exchange has seen work.
...
**Allan and his companies — the means to operate aggressively.** The Filipino operating company is Allan's to run: he holds the majority, he is its President, and it is capitalised from day one — PGC's equity, PGC's shareholder loans beyond it, and the ₱5 million line into the Casalugan plant — so it can move on the ground without waiting on anyone's board. It gets its own Minahang Bayan at Jose Panganiban — declared first, so that no later permit or large-scale project touches that ground without the cooperative's consent — and its own plant on Allan's own land beside it; the lending book and the rental fleet to put money and machines into the shafts and cooperatives it already knows; the tax-exempt gold channel; and the LAB X equipment programme building for it. Everything the law reserves to Filipinos sits in Allan's company by design, and the exploration chapter, when it opens, runs through positions Allan and Stephen already hold. The estate's own interests are carried separately, so the family's land and Allan's operations never get in each other's way.

**Stephen — the operating and engineering partner.** Wave 1 puts the money into the plant Stephen operates and the circuit he designs: the ₱5 million activation, released in stages as the plant comes up, the LAB X tables, the toll station, and a ready ore-supply and gold channel around it. As Wave 1 delivers, his role widens under contract to the design of the AVI plant and the equipment programme, and the services arm turns his methods into fees each time another operator wants what he built here. His offer of shares in a smaller processing operation, his coexistence framing for Wave 3 and his position in NIBDC are all part of the model — on written terms, and earned as each stage is delivered.
