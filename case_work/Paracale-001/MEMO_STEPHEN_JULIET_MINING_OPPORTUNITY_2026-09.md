...
## 4B. Two things that travel with us — the trade school and the services arm
...
**Why this matters to the structure.** Training and technical services are not nationalised activities under Philippine law, so — unlike the mine — they can be owned outright by the Canadian side or by LandTek, and their fees are not capped by the 40% rule. The school and the services arm are therefore natural homes for Canadian and LandTek economics that sit alongside, not inside, the 60/40 operating company. Counsel confirms the entity design; the intent is that the region pays us to replicate what we build here.
