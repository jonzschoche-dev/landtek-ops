...
**A sustainable mining trade school.** We plan to train our own future miners, and the region's, in a school built around the way we intend to mine: mercury-free processing, mine safety, ground support and ventilation, gravity and leach circuits, assaying and sampling, environmental monitoring, cooperative governance and record-keeping — and **bioremediation**: the biological and phytoremediation methods for restoring mercury- and cyanide-affected tailings, soils and watercourses that a century of artisanal mining has left across the district. Practically: TESDA-registered programmes so graduates hold recognised certificates; the MFPS and, later, the AVI plant as the training floor; the LAB X workshop as the fabrication classroom; and a curriculum that doubles as the safety-and-health and community-development programmes the small-scale mining rules already require of every contractor. Funding lines that fit it exactly exist — planetGOLD's formalisation agenda, TESDA scholarships, LGU and provincial skills budgets, and the contractors' own mandatory training obligations — so the school can be built as a funded programme rather than a cost centre. Its first graduates are the crews for Waves 1 and 2.
...
| Allan + Jonathan + Stephen | 31 Oct (proposed) | Trade school outline: first three TESDA-registrable programmes (mercury-free processing, mine safety, bioremediation), training floor at the MFPS, funding lines to approach; services-arm entity and first two regional prospects |
...
| Future miners and trainees | Their labour and the region's next workforce | TESDA-registered certificates; paid training on the working plants; first call on Wave-1 and Wave-2 crews |
