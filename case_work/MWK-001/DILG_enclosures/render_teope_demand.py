...
SRC = f"{MWK}/DEMAND_TEOPE_FINAL_2026-08-26.md"
OUT = f"{MWK}/DEMAND_TEOPE_FINAL_2026-08-26.pdf"
FOLIO = (8.5 * inch, 13.0 * inch)
FOOT = "Zschoche (AIF, Keesey Zschoche) — Final Demand, TCT T-48336, 26 Aug 2026"
...
while i < len(lines):
    ...
    if not raw.strip():
        i += 1; continue
    if in_addr:
        if raw.startswith("Dear Mr. Teope"):
            in_addr = False
...
doc = SimpleDocTemplate(OUT, pagesize=FOLIO, leftMargin=1.0*inch, rightMargin=1.0*inch,
                        ...
                        title="Final Demand — Teope, TCT T-48336, Brgy 1 Poblacion Mercedes, 26 Aug 2026",
