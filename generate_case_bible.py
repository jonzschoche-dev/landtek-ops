...
BIBLE_NARRATIVE_CRITICAL_FACTS = {
    "MWK-001": (
        ...
        "- **Mediation 2 June 2026 — IMPASSE** (verified chat_notes#1209). "
        "Present: Princess Balane Torralba and Engr. Erwin H. Balane. "
        "Jonathan not in attendance. Agreed to disagree; case proceeds to trial. "
        "Do NOT use superseded chat_notes#1208 (archived inference).\n"
