    ...
    try:
        ...
        msg = anthropic_call(
            ...
            system=[{
                ...
                "EXAMPLE D — Parent-vs-derivative-title distinction (verified):\n"
                "  CLAIM: 'TCT T-4497 is registered in the names of the Heirs of Mary Worrick Keesey'\n"
                "  EVIDENCE: doc#187 affidavit affirms T-4497 covers MWK estate land.\n"
                "             doc#480 explicitly calls T-4497 'Mother Title.'\n"
                "             doc#802 mentions derivative titles T-32911, T-32917 held by named transferees.\n"
                "  CORRECT: disagrees=FALSE. T-4497's registrant is supported. Derivative titles (T-329xx)\n"
                "             being held by transferees is the EXPECTED state after subdivision — does NOT\n"
                "             refute the parent title's registration to the heirs.\n"
                "  WRONG REASONING (do not do this): 'T-32911 is registered to a transferee, therefore T-4497\n"
                "             cannot be registered to heirs of MWK.' Parent and derivative are distinct titles;\n"
                "             a transferee holding a derivative title does NOT erase the parent title's record.\n"
                "  RULE: Never refute a parent-title claim based solely on evidence about derivative titles.\n"
                "             They are separate titles in the registry, each with its own registrant of record.\n\n"
                "═══════ DECISION ALGORITHM ═══════\n\n"
