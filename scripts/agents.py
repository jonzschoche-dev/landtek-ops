...
AGENTS = [
    ...
    ("case_dossier_pdf",     "scannable corpus dossier → Telegram (timeline + docs-by-category + facts, all linked)", "det",
     "on demand", "", "live", "the case-bundle front matter for quick counsel scan; case_dossier_pdf.py MATTER --send"),
