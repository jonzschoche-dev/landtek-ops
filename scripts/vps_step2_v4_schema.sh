#!/usr/bin/env bash
# LeoLandTek v4 — Step 2: schema migrations.
# Idempotent; re-run safely.
set -euo pipefail

LANDTEK=/root/landtek
SQL_FILE="$LANDTEK/scripts/v4_schema.sql"
mkdir -p "$LANDTEK/scripts"
...
echo "===== Running v4 schema migration ====="
docker exec -i n8n-postgres-1 psql -U n8n -d n8n < "$SQL_FILE"
echo
